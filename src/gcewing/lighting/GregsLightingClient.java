...
public class GregsLightingClient extends BaseModClient {

//	public static Minecraft minecraft;
//	public static File mcdir;
		
	public GregsLightingClient(BaseMod base) {
		super(base);
...
//	}
	...
	void registerRenderers() {
		GregsLighting mod = GregsLighting.mod;
		addBlockRenderer(new RendererFloodlight(), mod.floodlight);
	}
	
	@Override
	void registerScreens() {
		//System.out.printf("GregsLightingClient.registerScreens\n");
		addScreen(GregsLighting.guiFloodlightCarbide, GuiFloodlightCarbide.class);
	}
